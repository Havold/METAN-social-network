...
namespace Instagram
{
    public partial class FiveImage : UserControl
    {
        ...
        public void loadImage(string idPost, int numImage)
        {
            ...
            pictureBox2.Image = Image.FromFile(imagePath[2]);
            pictureBox3.Image = Image.FromFile(imagePath[3]);
            pictureBox4.Image = Image.FromFile(imagePath[4]);
